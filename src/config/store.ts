...
export const STORE_SLOGAN = "Acessórios que transformam o básico em incrível!";
...
export const STORE_MAP_URL =
  ...
  encodeURIComponent("Galeria Maria Mucci 54 loja 113A Calçadão Viçosa MG");
export const STORE_PICKUP =
  "Retirada exclusiva na loja — grátis";
